...
steal.Inflector = {
  ...
  pluralize: function(word) {
    ...
    for (var i = 0; i < steal.Inflector.Inflections.irregular.length; i++) {
    ...
    for (var i = 0; i < steal.Inflector.Inflections.plural.length; i++) {
  ...
  singularize: function(word) {
    ...
    for (var i = 0; i < steal.Inflector.Inflections.singular.length; i++) {
